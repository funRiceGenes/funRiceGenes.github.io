...
description: ""
category: genes
tags: [leaf, resistance, panicle, blast, blast resistance, growth, drought, stress, abscisic acid, ABA, drought stress, drought resistance, drought sensitivity, drought stress , root, root elongation, plasma membrane, primary root, phosphorus, root length]
---
...
* **Key message**  
    ...
    + These results suggest that the G protein ¦Ã subunit qPE9-1 in rice plants modulates root elongation for phosphorus uptake by involving the 14-3-3 protein OsGF14b and PM H+ -ATPase, which is required for rice P use
